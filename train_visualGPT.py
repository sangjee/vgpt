...
if __name__ == '__main__':
    ...
    parser.add_argument("--pretrained_path",type=str, default='/home/lab/sangjee/strok/data/pretrained_model/gpt2_hallym_pretrained.ckpt')
    ...
    model = Transformer_visualgpt(text_field.vocab.stoi['<?'], encoder, args.gpt_model_type, args.decoder_layer,tau=args.tau, args.pretrained_path).to(device)
