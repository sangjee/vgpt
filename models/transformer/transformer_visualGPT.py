...
state_dict = torch.load('/home/lab/sangjee/strok/data/pretrained_model/gpt2_hallym_pretrained.ckpt', map_location='cpu' if not torch.cuda.is_available() else None)['state_dict']
