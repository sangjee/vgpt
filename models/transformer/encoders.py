...
class EncoderLayer(nn.Module):
    def __init__(self, d_model=768, d_k=64, d_v=64, h=12, d_ff=768, dropout=.1, identity_map_reordering=False,
...
class MultiLevelEncoder(nn.Module):
    def __init__(self, N, padding_idx, d_model=768, d_k=64, d_v=64, h=12, d_ff=768, dropout=.1,
